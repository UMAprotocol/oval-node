...
export interface StandardChainlinkFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_TRAVERSAL"
      | "create"
...
export interface StandardChainlinkFactory extends BaseContract {
  connect(runner?: ContractRunner | null): StandardChainlinkFactory;
  waitForDeployment(): Promise<this>;

  interface: StandardChainlinkFactoryInterface;
  ...
  create: TypedContractMethod<
    [source: AddressLike, lockWindow: BigNumberish, maxAge: BigNumberish],
    [string],
    "nonpayable"
  >;
