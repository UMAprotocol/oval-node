...
export interface StandardPythFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_TRAVERSAL"
      | "PYTH"
...
export interface StandardPythFactory extends BaseContract {
  connect(runner?: ContractRunner | null): StandardPythFactory;
  waitForDeployment(): Promise<this>;

  interface: StandardPythFactoryInterface;
  ...
  create: TypedContractMethod<
    [pythPriceId: BytesLike, lockWindow: BigNumberish, maxAge: BigNumberish],
    [string],
    "nonpayable"
  >;
