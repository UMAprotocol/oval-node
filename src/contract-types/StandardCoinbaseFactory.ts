...
export interface StandardCoinbaseFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_TRAVERSAL"
      | "SOURCE"
...
export interface StandardCoinbaseFactory extends BaseContract {
  connect(runner?: ContractRunner | null): StandardCoinbaseFactory;
  waitForDeployment(): Promise<this>;

  interface: StandardCoinbaseFactoryInterface;
  ...
  create: TypedContractMethod<
    [ticker: string, lockWindow: BigNumberish, maxAge: BigNumberish],
    [string],
    "nonpayable"
  >;
